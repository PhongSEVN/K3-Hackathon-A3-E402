...
- **Vai trò**: Frontend Developer (Client)
- **Nhiệm vụ chính**:
  - Hỗ trợ Phong xây dựng giao diện người dùng (Client-side) của dự án.
  - Phối hợp với Linh để tích hợp dữ liệu từ Database (PostgreSQL) lên UI.
